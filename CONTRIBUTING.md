...
Report bugs at https://github.com/mothra729/data_centres_ontario/issues.
...
data_centres_ontario could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.
...
The best way to send feedback is to file an issue at https://github.com/mothra729/data_centres_ontario/issues.
...
Ready to contribute? Here's how to set up `data_centres_ontario` for local development.

1. Fork the `data_centres_ontario` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/data_centres_ontario.git
   ```

3. Install your local copy with uv:

   ```sh
   cd data_centres_ontario/
   uv sync
   ```
